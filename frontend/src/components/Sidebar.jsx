...
const menuItems = [
  ...
  { path: '/analysis', label: '에이전트 관리', icon: '💻' },
  { path: '/process_analysis', label: '프로세스 분석', icon: '📈' },
  { path: '/events', label: '통합 로그', icon: '📂' },
  { path: '/forensics', label: '포렌식 덤프', icon: '💾' },
  { path: '/policy', label: '정책 설정', icon: '⚙️' },
];
